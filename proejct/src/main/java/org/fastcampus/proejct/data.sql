INSERT INTO `user_info` (`id`, `created_at`, `created_by`, `modified_at`, `modified_by`, `admin_check`, `email`,`exit_date`, `is_ban`, `name`, `password`)
VALUES (2, NOW(), 'system', NOW(), 'system', 1, 'email1@naver.com', NULL, 0, '김철수', '1234');
